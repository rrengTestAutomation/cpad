...
public class PermulationsArray {
    ...
    public static void main(String[] args) {
        ArrayList<String> str_perms = permutations( "ab" );
     // for ( String p : str_perms ) { System.out.println( p ); }
        System.out.println("QUANTITY = " + str_perms.size());
        System.out.println();
        
     // ArrayList<Integer[]> int_perms = permutations( new Integer[]{ 1, 2, 3 } );
     // for ( Integer[] p : int_perms ) System.out.println( arrayToString( p ) );
        
        ArrayList<String[]> combo_perms = permutations( new String[]{ "a", "b", "c", "d", "e" } );
        System.out.println("QUANTITY = " + combo_perms.size());
     // for ( String[] p : combo_perms ) System.out.println( arrayToString( p ) );
